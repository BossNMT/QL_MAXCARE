  ...
  return (
    <div className="d-flex header__right full-height">
      <Space size={4.5} style={{ marginTop: '8px' }}>
        <Avatar
          style={{ width: 24, height: 24, marginRight: '-1px', marginTop: '2px' }}
        ...
        <Button className="btn-control color-light font-weight-bold font-12" style={{ marginRight: '-5.1px' }} ghost>
          <span style={{ marginTop: '2px' }}>Tran</span>
        </Button>
        <Divider className="divider-control" type="vertical" />
        <Button className="btn-control color-light font-weight-bold font-12" ghost>
          <span style={{ marginTop: '2px' }}>Trang Chủ</span>
        </Button>
        <Button
          className="btn-control font-15"
          style={{ width: '33.73px', marginRight: '-0.8px', marginLeft: '-0.5px' }}
          ghost
        >
        ...
        <Button className="btn-control font-size-16" style={{ paddingLeft: '11.2px' }} ghost>
          <FontAwesomeIcon icon={faEnvelope} style={{ marginTop: '1.2px' }} />
        </Button>
        <Button className="btn-control" style={{ paddingLeft: '9px' }} ghost>
          <FontAwesomeIcon icon={faEarthAmericas} />
        </Button>
        <Button className="btn-control" style={{ fontSize: '13.9px', marginLeft: '-0.7px' }} ghost>

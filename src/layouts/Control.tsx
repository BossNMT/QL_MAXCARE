    ...
    return (
        <div className="d-flex header__right">
            <Space size={5}>
                ...
                />
                <Button className='btn-control color-light font-weight-bold font-12 p-r-l-8' ghost>Tran</Button>
                <Divider className='divider-control' type="vertical" />
                <Button className='btn-control color-light font-weight-bold font-12 p-r-l-8' ghost>Trang Chủ</Button>
